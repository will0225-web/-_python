...
model_name_combination=['Short']
confindence_combination=[0.8]
for model_choice in model_name_combination:    
    for confindence in confindence_combination:
        
        model_name=f'{model_choice}_correlatcion_win_rate_{confindence}_train_1723_test_2324_96_480_1031'
        combinations = ['_min_loss_更改持有期間止盈止損']
        #combinations = ['','_max_loss','_更改持有期間止盈止損','_max_loss_更改持有期間止盈止損','_min_loss_更改持有期間止盈止損','_min_loss_run_up']
        #combinations = ['','_max_loss','_更改持有期間止盈止損','_max_loss_更改持有期間止盈止損','_max_loss_runup']
        total_profit=0.3
        sharpe=0.2
        drawdown=0.5
        commom_ratio=0

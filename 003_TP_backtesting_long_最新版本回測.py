...
####開始進行回測數據紀錄和分析
    ...
    # 畫圖，並使用實際的累積Profit
    plt.figure(figsize=(14, 7))
    plt.plot(X_test['datetime'],X_test['total_profit'], label='profit')
    plt.legend()
...
name = 'Long_correlatcion_win_rate_0.8_11_13'

# 設置file_path變數，這邊是需要特定lookahed和TP的每一個測試資料檔案
base_file_path = fr'C:\\Users\\User\\Documents\\deep-learning\\will_lee\\spot_testing_data_11_13\\Backtesting_point_data'

# 定義輸出結果檔案的完整路徑
base_folder_path = r'C:\\Users\\User\\Documents\\deep-learning\\will_lee\\spot_testing_data_11_13'
sub_folder_name = f'Backtest_result_{name}'
# 完整資料夾路徑
...
with open(summary_file_path,mode='w',newline='') as file:
    ...
    for predict_lookahead in predict_lookaheads:
            ...
            # for predict_lookahead, threshold,ETP_thresholds, stop_loss, max_open_position in combinations:
                                    ...
                                    base_file_path,
                                    f'Long_Matrix_test_{predict_lookahead}_{threshold}_up_point.csv' )

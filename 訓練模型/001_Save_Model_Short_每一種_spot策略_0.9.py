...
with open(summary_file_path, mode='w', newline='') as file:
    ...
    for lookahead in range(96,482,24):
        for d in thresholds:
            ...
            f1_score_down_class_1,df_down,df_report_down,accuracy_down,auc_score_down = evaluate_model(lookahead,d, 0.9,base_folder_path=base_folder_path,sub_folder_name=sub_folder_name)

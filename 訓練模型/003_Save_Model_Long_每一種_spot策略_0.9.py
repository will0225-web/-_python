...
with open(summary_file_path, mode='w', newline='') as file:
    ...
    for lookahead in range(96,481,24):
        for d in thresholds:
            ...
            f1_score_up_class_1,df_up,df_report_up,accuracy_up, auc_score_up = evaluate_model(lookahead,d,0.9,base_folder_path=base_folder_path,sub_folder_name=sub_folder_name)
            writer.writerow(['','','','','',lookahead,d,accuracy_up, auc_score_up ,f1_score_up_class_1 ])

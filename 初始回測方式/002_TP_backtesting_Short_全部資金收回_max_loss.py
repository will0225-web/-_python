    ...
    for i in range(0, len(X_test)):
        if open_trades:
            ...
            for trade in open_trades[:]:
                    ...
                    trade['sl_price'] = max(trade.get('sl_price', entry_price * (1 - SL)), new_sl_price)
...
name='Short_correlatcion_win_rate_0.9_train_1723_test_2324_96_480_添加volume_log'
...
sub_folder_name = f'Backtest_result_{name}_max_loss'
# 完整資料夾路徑
...
summary_file_path = os.path.join(full_folder_path, f'A_Summary_{name}_max_loss.csv')
